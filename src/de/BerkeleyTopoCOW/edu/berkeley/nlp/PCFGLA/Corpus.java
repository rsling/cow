...
//    			if (n.getLabel().equals("@WHNP^g") || (n.getLabel().equals("WHNP") && n.getChildren().size() > 1))
  ...
  public static List<Tree<String>> binarizeAndFilterTrees(
    ...
    for (Tree<String> tree : trees) {
      ...
      if (true) {
        binarizedTrees.add(TreeAnnotations.processTree(tree,verticalAnnotations,horizontalAnnotations,binarization,manualAnnotation, markUnaryParents, false));
      } else {
